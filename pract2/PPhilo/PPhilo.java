...
public class PPhilo extends JPanel implements ActionListener {
    ...
    void simulate(String s) {
        ...
        Table t; 
        /* COMPLETAR */  // dentro de los CASE X hay que modificar el código para
                         // que cumpla con los requisitos que pide
                         // para ello --> completar DENTRO DEL FOR
        switch (type) {
         case 0: 
            ...
            break;
         case 1: 
         /*  Todos los filósofos cogen primero su tenedor derecho, 
          * excepto el número 4 (el último), que coge primero su tenedor 
          izquierdo */
            ...
            break;
         case 2: 
         /*  Los filósofos pares cogen primero su tenedor derecho 
          * mientras que los filósofos impares cogen primero su tenedor 
          * izquierdo   */
            ...
            break;
         case 3: 
         /*  Los filósofos, o bien cogen los dos tenedores o, 
          * si alguno está ocupado, no cogen ninguno*/
            ...
            break;
         case 4: 
         /* Como máximo pueden haber cuatro filósofos sentados a la mesa */
